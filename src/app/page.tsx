    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroLogoBillboard
          ...
          imageAlt="Delicious FoodBading pizza"
          frameStyle="card"
        />
      </div>
      ...
      <div id="about" data-section="about">
        <FeatureCardTwentyOne
          title="About FoodBading"
          description="Discover what makes FoodBading the best pizza destination in town. We are committed to quality, taste, and customer satisfaction."
          ...
          imageAlt="FoodBading restaurant interior"
          accordionItems={[
            {
              id: "1",
      ...
      <div id="testimonial" data-section="testimonial">
        <TestimonialCardTwo
          title="Customer Love"
          description="See what our happy customers have to say about FoodBading pizza"
          testimonials={[
            {
              id: "1",
              name: "Sarah Johnson",
              role: "Food Enthusiast",
              testimonial: "The best pizza I have ever tasted! Fresh ingredients, perfect texture, and amazing flavor. Highly recommend FoodBading!",
            ...
            },
            {
              ...
              testimonial: "Consistently excellent quality and fast delivery. FoodBading has become my go-to pizza place. Never disappoints!",
            ...
            },
            {
              ...
              testimonial: "We order from FoodBading for all our events. The team is professional, the pizza is delicious, and prices are fair.",
      ...
      <div id="locations" data-section="locations">
        <TeamCardTwo
          title="Our Locations"
          description="Visit FoodBading at any of our convenient locations"
          members={[
            {
              id: "1",
              ...
              imageAlt: "Downtown FoodBading location"
            },
            {
              id: "2",
              ...
              imageAlt: "Westside FoodBading location"
            }
          ]}
          gridVariant="uniform-all-items-equal"
          animationType="slide-up"
      ...
      <div id="footer" data-section="footer">
        <FooterBase
          logoText="FoodBading"
          copyrightText="© 2025 FoodBading Pizza. All rights reserved."
          columns={[
            {
              title: "Menu",
              items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: "Email: info@foodbading.com", href: "mailto:info@foodbading.com" },
