    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroLogoBillboard
          ...
          imageAlt="Delicious FoodBads pizza"
          frameStyle="card"
        />
      </div>
      ...
      <div id="about" data-section="about">
        <FeatureCardTwentyOne
          title="About FoodBads"
          description="Discover what makes FoodBads the best pizza destination in town. We are committed to quality, taste, and customer satisfaction."
          ...
          imageAlt="FoodBads restaurant interior"
          accordionItems={[
            {
              id: "1",
      ...
      <div id="testimonial" data-section="testimonial">
        <TestimonialCardTwo
          title="Customer Love"
          description="See what our happy customers have to say about FoodBads pizza"
          testimonials={[
            {
              id: "1",
              name: "Sarah Johnson",
              role: "Food Enthusiast",
              testimonial: "The best pizza I have ever tasted! Fresh ingredients, perfect texture, and amazing flavor. Highly recommend FoodBads!",
            ...
            },
            {
              ...
              testimonial: "Consistently excellent quality and fast delivery. FoodBads has become my go-to pizza place. Never disappoints!",
            ...
            },
            {
              ...
              testimonial: "We order from FoodBads for all our events. The team is professional, the pizza is delicious, and prices are fair.",
      ...
      <div id="locations" data-section="locations">
        <TeamCardTwo
          title="Our Locations"
          description="Visit FoodBads at any of our convenient locations"
          members={[
            {
              id: "1",
              ...
              imageAlt: "Downtown FoodBads location"
            },
            {
              id: "2",
              ...
              imageAlt: "Westside FoodBads location"
            }
          ]}
          gridVariant="uniform-all-items-equal"
          animationType="slide-up"
      ...
      <div id="footer" data-section="footer">
        <FooterBase
          logoText="FoodBads"
          copyrightText="© 2025 FoodBads Pizza. All rights reserved."
          columns={[
            {
              title: "Menu",
              items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: "Email: info@foodbads.com", href: "mailto:info@foodbads.com" },
