    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroLogoBillboard
          ...
          imageAlt="Delicious FoodCor pizza"
          frameStyle="card"
        />
      </div>
      ...
      <div id="about" data-section="about">
        <FeatureCardTwentyOne
          title="About FoodCor"
          description="Discover what makes FoodCor the best pizza destination in town. We are committed to quality, taste, and customer satisfaction."
          ...
          imageAlt="FoodCor restaurant interior"
          accordionItems={[
            {
              id: "1",
      ...
      <div id="testimonial" data-section="testimonial">
        <TestimonialCardTwo
          title="Customer Love"
          description="See what our happy customers have to say about FoodCor pizza"
          testimonials={[
            {
              id: "1",
              name: "Sarah Johnson",
              role: "Food Enthusiast",
              testimonial: "The best pizza I have ever tasted! Fresh ingredients, perfect texture, and amazing flavor. Highly recommend FoodCor!",
            ...
            },
            {
              ...
              testimonial: "Consistently excellent quality and fast delivery. FoodCor has become my go-to pizza place. Never disappoints!",
            ...
            },
            {
              ...
              testimonial: "We order from FoodCor for all our events. The team is professional, the pizza is delicious, and prices are fair.",
      ...
      <div id="locations" data-section="locations">
        <TeamCardTwo
          title="Our Locations"
          description="Visit FoodCor at any of our convenient locations"
          members={[
            {
              id: "1",
              ...
              imageAlt: "Downtown FoodCor location"
            },
            {
              id: "2",
              ...
              imageAlt: "Westside FoodCor location"
            }
          ]}
          gridVariant="uniform-all-items-equal"
          animationType="slide-up"
      ...
      <div id="footer" data-section="footer">
        <FooterBase
          logoText="FoodCor"
          copyrightText="© 2025 FoodCor Pizza. All rights reserved."
          columns={[
            {
              title: "Menu",
              items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: "Email: info@foodcor.com", href: "mailto:info@foodcor.com" },
